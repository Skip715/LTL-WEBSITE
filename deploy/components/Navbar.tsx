          ...
          <Link href="/" className="flex items-center gap-3">
            <div className="border-r border-white border-opacity-30 pr-3 mr-1">
              <div className="text-white font-black text-2xl tracking-tight leading-none">
                <span className="text-[#2b6cb0]">L</span>T<span className="text-[#2b6cb0]">L</span>
              </div>
            </div>
            <div>
              <div className="text-white font-bold text-sm leading-tight">LONG TERM LEASING S.R.L</div>
        ...
        {isOpen && (
          <div className="md:hidden py-4 border-t border-white border-opacity-10">
            <div className="flex flex-col gap-4">
              ...
              <Link
                href="/contact"
                className="bg-[#2b6cb0] text-white px-5 py-2 rounded-lg font-semibold hover:bg-[#3b82c4] transition-colors text-center"
